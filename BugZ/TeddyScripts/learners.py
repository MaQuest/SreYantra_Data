...
def local_model(count_vect, tfidf_transformer, train_test_sizes, algs, dependencies,skf):
    ...
    for dependency in dependencies:
        ...
        for alg in algs:
            model = alg[0]
            alg_name = alg[1]
            print("Local {} model started".format(alg_name))
            ...
            for size in train_test_sizes:
                ...
                for project in projects:
                    ...
                    if (binaryclass):
                        ...
                        "Training Set Size": len(train_x)*2,
                        "Test Set Size": len(test_x)*2,
                        ...
                        results = results.append(result, ignore_index=True)
                print("Local {} model ended".format(alg_name))
...
def global_model(count_vect, tfidf_transformer, train_test_sizes, algs, dependencies,skf):
    ...
    for dependency in dependencies:
        ...
        for alg in algs:
            model = alg[0]
            alg_name = alg[1]
            print("Global {} model started".format(alg_name))
            for size in train_test_sizes:
                train_size = size[0]
                test_size = size[1]
                projects = size[2]
                    ...
                    for test_project in projects:
                        ...
                        if (binaryclass):
                            ...
                            result = {"Algorithm": alg_name,
                                      ...
                                      "F1-Score Average" : "{:.2f}".format(np.average(multi_f1))}
                            results = results.append(result, ignore_index=True)
                print("Global {} {} model ended".format(alg_name, project))
