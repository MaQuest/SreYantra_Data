...
def readCombineSelect():
    ...
    df_all_data = df_all_data.append(pd.read_csv("Data_part2.csv"), sort=True)
...
def readRootData():
    df_root = pd.read_csv("../RootLevel/AllData.csv")
...
def main():
    ...
    for index,ele in df_root.iterrows():
        ...
        print (lst_depends_on,lst_blocks,lst_duplicate)
    ...
    df_pairs_dependent.to_csv("Release_Level1PairsReadyData.csv")
